...
function generateLevels(lang) {
    ...
    // أسئلة متنوعة لكل مستوى (تختلف عن المستوى السابق)
    const quizzes = {
        "Python": [
            { question: "ما هي دالة الطباعة في Python؟", options: ["print()", "echo()", "console.log()"], correct: 0 },
            { question: "أي من التالي يمثل نوع بيانات صحيح في Python؟", options: ["int", "float", "str"], correct: 0 },
            { question: "ما هو ناتج `10 % 3` في Python؟", options: ["1", "3", "0"], correct: 0 },
            { question: "كم مرة ستنفذ الحلقة `for i in range(3)`؟", options: ["2", "3", "4"], correct: 1 },
            { question: "ما هو ناتج `len('Hello')` في Python؟", options: ["4", "5", "6"], correct: 1 },
            { question: "كيف تصل إلى العنصر الأول في قائمة `[10,20,30]`؟", options: ["list[0]", "list[1]", "list[2]"], correct: 0 },
            { question: "أي كلمة تستخدم لإنشاء دالة في Python؟", options: ["def", "function", "func"], correct: 0 },
            { question: "كيف تفتح ملف للقراءة في Python؟", options: ["open('file.txt','r')", "open('file.txt','w')", "open('file.txt','a')"], correct: 0 },
            { question: "ما هو ناتج `2 ** 3` في Python؟", options: ["6", "8", "9"], correct: 1 },
            { question: "أي من التالي يمثل قائمة في Python؟", options: ["[1,2,3]", "{1,2,3}", "(1,2,3)"], correct: 0 }
        ],
        "JavaScript": [
            ...
            { question: "ما هو ناتج `10 % 3` في JS؟", options: ["1", "3", "0"], correct: 0 },
            { question: "كم مرة ستنفذ الحلقة `for(let i=0; i<3; i++)`؟", options: ["2", "3", "4"], correct: 1 },
            { question: "ما هو ناتج `'Hello'.length` في JS؟", options: ["4", "5", "6"], correct: 1 },
            { question: "كيف تصل إلى العنصر الأول في مصفوفة `[10,20,30]`؟", options: ["arr[0]", "arr[1]", "arr[2]"], correct: 0 },
            { question: "أي كلمة تستخدم لإنشاء دالة في JS؟", options: ["function", "def", "func"], correct: 0 },
            { question: "كيف تكتب تعليقاً في JS؟", options: ["// تعليق", "# تعليق", "/* تعليق */"], correct: 0 },
            { question: "ما هو ناتج `2 ** 3` في JS؟", options: ["6", "8", "9"], correct: 1 },
            { question: "أي من التالي يمثل مصفوفة في JS؟", options: ["[1,2,3]", "{1,2,3}", "(1,2,3)"], correct: 0 }
        ],
        "C++": [
            ...
            { question: "ما هو ناتج `10 % 3` في C++؟", options: ["1", "3", "0"], correct: 0 },
            { question: "كم مرة ستنفذ الحلقة `for(int i=0; i<3; i++)`؟", options: ["2", "3", "4"], correct: 1 },
            { question: "ما هو ناتج `sizeof(int)` في C++؟", options: ["2", "4", "8"], correct: 1 },
            { question: "كيف تصل إلى العنصر الأول في مصفوفة `int arr[3]={10,20,30}`؟", options: ["arr[0]", "arr[1]", "arr[2]"], correct: 0 },
            { question: "أي كلمة تستخدم لإنشاء دالة في C++؟", options: ["void", "function", "func"], correct: 0 },
            { question: "كيف تكتب تعليقاً في C++؟", options: ["// تعليق", "# تعليق", "/* تعليق */"], correct: 0 },
            { question: "ما هو ناتج `2 * 3` في C++؟", options: ["5", "6", "7"], correct: 1 },
            { question: "أي من التالي يمثل مصفوفة في C++؟", options: ["int arr[3]", "int arr(3)", "int arr={1,2,3}"], correct: 0 }
        ],
        "Java": [
            { question: "ما هي دالة الطباعة في Java؟", options: ["System.out.println()", "print()", "console.log()"], correct: 0 },
            { question: "أي من التالي يمثل نوع بيانات صحيح؟", options: ["int", "float", "String"], correct: 0 },
            { question: "ما هو ناتج `10 % 3` في Java؟", options: ["1", "3", "0"], correct: 0 },
            { question: "كم مرة ستنفذ الحلقة `for(int i=0; i<3; i++)`؟", options: ["2", "3", "4"], correct: 1 },
            { question: "ما هو ناتج `'Hello'.length()` في Java؟", options: ["4", "5", "6"], correct: 1 },
            { question: "كيف تصل إلى العنصر الأول في مصفوفة `int[] arr={10,20,30}`؟", options: ["arr[0]", "arr[1]", "arr[2]"], correct: 0 },
            { question: "أي كلمة تستخدم لإنشاء دالة في Java؟", options: ["void", "function", "func"], correct: 0 },
            { question: "كيف تكتب تعليقاً في Java؟", options: ["// تعليق", "# تعليق", "/* تعليق */"], correct: 0 },
            { question: "ما هو ناتج `2 * 3` في Java؟", options: ["5", "6", "7"], correct: 1 },
            { question: "أي من التالي يمثل مصفوفة في Java؟", options: ["int[] arr", "int arr[]", "int arr(3)"], correct: 0 }
        ],
        "C#": [
            ...
            { question: "ما هو ناتج `10 % 3` في C#؟", options: ["1", "3", "0"], correct: 0 },
            { question: "كم مرة ستنفذ الحلقة `for(int i=0; i<3; i++)`؟", options: ["2", "3", "4"], correct: 1 },
            { question: "ما هو ناتج `'Hello'.Length` في C#؟", options: ["4", "5", "6"], correct: 1 },
            { question: "كيف تصل إلى العنصر الأول في مصفوفة `int[] arr={10,20,30}`؟", options: ["arr[0]", "arr[1]", "arr[2]"], correct: 0 },
            { question: "أي كلمة تستخدم لإنشاء دالة في C#؟", options: ["void", "function", "func"], correct: 0 },
            { question: "كيف تكتب تعليقاً في C#؟", options: ["// تعليق", "# تعليق", "/* تعليق */"], correct: 0 },
            { question: "ما هو ناتج `2 * 3` في C#؟", options: ["5", "6", "7"], correct: 1 },
            { question: "أي من التالي يمثل مصفوفة في C#؟", options: ["int[] arr", "int arr[]", "int arr(3)"], correct: 0 }
        ],
        "PHP": [
            ...
            { question: "ما هو ناتج `10 % 3` في PHP؟", options: ["1", "3", "0"], correct: 0 },
            { question: "كم مرة ستنفذ الحلقة `for($i=0; $i<3; $i++)`؟", options: ["2", "3", "4"], correct: 1 },
            { question: "ما هو ناتج `strlen('Hello')` في PHP؟", options: ["4", "5", "6"], correct: 1 },
            { question: "كيف تصل إلى العنصر الأول في مصفوفة `$arr=[10,20,30]`؟", options: ["$arr[0]", "$arr[1]", "$arr[2]"], correct: 0 },
            { question: "أي كلمة تستخدم لإنشاء دالة في PHP؟", options: ["function", "def", "func"], correct: 0 },
            { question: "كيف تكتب تعليقاً في PHP؟", options: ["// تعليق", "# تعليق", "/* تعليق */"], correct: 0 },
            { question: "ما هو ناتج `2 * 3` في PHP؟", options: ["5", "6", "7"], correct: 1 },
            { question: "أي من التالي يمثل مصفوفة في PHP؟", options: ["$arr = [1,2,3]", "$arr = (1,2,3)", "$arr = {1,2,3}"], correct: 0 }
        ],
        "Swift": [
            ...
            { question: "ما هو ناتج `10 % 3` في Swift؟", options: ["1", "3", "0"], correct: 0 },
            { question: "كم مرة ستنفذ الحلقة `for i in 0..<3`؟", options: ["2", "3", "4"], correct: 1 },
            { question: "ما هو ناتج `'Hello'.count` في Swift؟", options: ["4", "5", "6"], correct: 1 },
            { question: "كيف تصل إلى العنصر الأول في مصفوفة `let arr=[10,20,30]`؟", options: ["arr[0]", "arr[1]", "arr[2]"], correct: 0 },
            { question: "أي كلمة تستخدم لإنشاء دالة في Swift؟", options: ["func", "function", "def"], correct: 0 },
            { question: "كيف تكتب تعليقاً في Swift؟", options: ["// تعليق", "# تعليق", "/* تعليق */"], correct: 0 },
            { question: "ما هو ناتج `2 * 3` في Swift؟", options: ["5", "6", "7"], correct: 1 },
            { question: "أي من التالي يمثل مصفوفة في Swift؟", options: ["[1,2,3]", "{1,2,3}", "(1,2,3)"], correct: 0 }
        ],
        "Kotlin": [
            ...
            { question: "ما هو ناتج `10 % 3` في Kotlin؟", options: ["1", "3", "0"], correct: 0 },
            { question: "كم مرة ستنفذ الحلقة `for(i in 0..2)`؟", options: ["2", "3", "4"], correct: 1 },
            { question: "ما هو ناتج `'Hello'.length` في Kotlin؟", options: ["4", "5", "6"], correct: 1 },
            { question: "كيف تصل إلى العنصر الأول في قائمة `val arr=listOf(10,20,30)`؟", options: ["arr[0]", "arr[1]", "arr[2]"], correct: 0 },
            { question: "أي كلمة تستخدم لإنشاء دالة في Kotlin؟", options: ["fun", "function", "def"], correct: 0 },
            { question: "كيف تكتب تعليقاً في Kotlin؟", options: ["// تعليق", "# تعليق", "/* تعليق */"], correct: 0 },
            { question: "ما هو ناتج `2 * 3` في Kotlin؟", options: ["5", "6", "7"], correct: 1 },
            { question: "أي من التالي يمثل قائمة في Kotlin؟", options: ["listOf(1,2,3)", "[1,2,3]", "{1,2,3}"], correct: 0 }
        ],
        "Go": [
            ...
            { question: "ما هو ناتج `10 % 3` في Go؟", options: ["1", "3", "0"], correct: 0 },
            { question: "كم مرة ستنفذ الحلقة `for i:=0; i<3; i++`؟", options: ["2", "3", "4"], correct: 1 },
            { question: "ما هو ناتج `len('Hello')` في Go؟", options: ["4", "5", "6"], correct: 1 },
            { question: "كيف تصل إلى العنصر الأول في مصفوفة `arr:=[...]int{10,20,30}`؟", options: ["arr[0]", "arr[1]", "arr[2]"], correct: 0 },
            { question: "أي كلمة تستخدم لإنشاء دالة في Go؟", options: ["func", "function", "def"], correct: 0 },
            { question: "كيف تكتب تعليقاً في Go؟", options: ["// تعليق", "# تعليق", "/* تعليق */"], correct: 0 },
            { question: "ما هو ناتج `2 * 3` في Go؟", options: ["5", "6", "7"], correct: 1 },
            { question: "أي من التالي يمثل مصفوفة في Go؟", options: ["[3]int{1,2,3}", "[]int{1,2,3}", "int{1,2,3}"], correct: 0 }
        ],
        "Rust": [
            ...
            { question: "ما هو ناتج `10 % 3` في Rust؟", options: ["1", "3", "0"], correct: 0 },
            { question: "كم مرة ستنفذ الحلقة `for i in 0..3`؟", options: ["2", "3", "4"], correct: 1 },
            { question: "ما هو ناتج `'Hello'.len()` في Rust؟", options: ["4", "5", "6"], correct: 1 },
            { question: "كيف تصل إلى العنصر الأول في مصفوفة `let arr=[10,20,30]`؟", options: ["arr[0]", "arr[1]", "arr[2]"], correct: 0 },
            { question: "أي كلمة تستخدم لإنشاء دالة في Rust؟", options: ["fn", "function", "def"], correct: 0 },
            { question: "كيف تكتب تعليقاً في Rust؟", options: ["// تعليق", "# تعليق", "/* تعليق */"], correct: 0 },
            { question: "ما هو ناتج `2 * 3` في Rust؟", options: ["5", "6", "7"], correct: 1 },
            { question: "أي من التالي يمثل مصفوفة في Rust؟", options: ["[1,2,3]", "{1,2,3}", "(1,2,3)"], correct: 0 }
        ]
    };
